...
{
    /* TokenNone, */ { 0, 0, 0, (char*)"none" },
    /* TokenComma, */ { 0, 0, 0, (char*)"," },
    /* TokenAssign, */ { 0, 0, 2, (char*)"=" }, /* TokenAddAssign, */ { 0, 0, 2, (char*)"+=" }, /* TokenSubtractAssign, */ { 0, 0, 2, (char*)"-=" },
    /* TokenMultiplyAssign, */ { 0, 0, 2, (char*)"*=" }, /* TokenDivideAssign, */ { 0, 0, 2, (char*)"/=" }, /* TokenModulusAssign, */ { 0, 0, 2, (char*)"%=" },
    /* TokenShiftLeftAssign, */ { 0, 0, 2, (char*)"<<=" }, /* TokenShiftRightAssign, */ { 0, 0, 2, (char*)">>=" }, /* TokenArithmeticAndAssign, */ { 0, 0, 2, (char*)"&=" },
    /* TokenArithmeticOrAssign, */ { 0, 0, 2, (char*)"|=" }, /* TokenArithmeticExorAssign, */ { 0, 0, 2, (char*)"^=" },
    /* TokenQuestionMark, */ { 0, 0, 3, (char*)"?" }, /* TokenColon, */ { 0, 0, 3, (char*)":" },
    /* TokenLogicalOr, */ { 0, 0, 4, (char*)"||" },
    /* TokenLogicalAnd, */ { 0, 0, 5, (char*)"&&" },
    /* TokenArithmeticOr, */ { 0, 0, 6, (char*)"|" },
    /* TokenArithmeticExor, */ { 0, 0, 7, (char*)"^" },
    /* TokenAmpersand, */ { 14, 0, 8, (char*)"&" },
    /* TokenEqual, */  { 0, 0, 9, (char*)"==" }, /* TokenNotEqual, */ { 0, 0, 9, (char*)"!=" },
    /* TokenLessThan, */ { 0, 0, 10, (char*)"<" }, /* TokenGreaterThan, */ { 0, 0, 10, (char*)">" }, /* TokenLessEqual, */ { 0, 0, 10, (char*)"<=" }, /* TokenGreaterEqual, */ { 0, 0, 10, (char*)">=" },
    /* TokenShiftLeft, */ { 0, 0, 11, (char*)"<<" }, /* TokenShiftRight, */ { 0, 0, 11, (char*)">>" },
    /* TokenPlus, */ { 14, 0, 12, (char*)"+" }, /* TokenMinus, */ { 14, 0, 12, (char*)"-" },
    /* TokenAsterisk, */ { 14, 0, 13, (char*)"*" }, /* TokenSlash, */ { 0, 0, 13, (char*)"/" }, /* TokenModulus, */ { 0, 0, 13, (char*)"%" },
    /* TokenIncrement, */ { 14, 15, 0, (char*)"++" }, /* TokenDecrement, */ { 14, 15, 0, (char*)"--" }, /* TokenUnaryNot, */ { 14, 0, 0, (char*)"!" }, /* TokenUnaryExor, */ { 14, 0, 0, (char*)"~" }, /* TokenSizeof, */ { 14, 0, 0, (char*)"sizeof" }, /* TokenCast, */ { 14, 0, 0, (char*)"cast" },
    /* TokenLeftSquareBracket, */ { 0, 0, 15, (char*)"[" }, /* TokenRightSquareBracket, */ { 0, 15, 0, (char*)"]" }, /* TokenDot, */ { 0, 0, 15, (char*)"." }, /* TokenArrow, */ { 0, 0, 15, (char*)"->" },
    /* TokenOpenBracket, */ { 15, 0, 0, (char*)"(" }, /* TokenCloseBracket, */ { 0, 15, 0, (char*)")" }
};
...
{
    struct ExpressionStack *StackNode = (ExpressionStack*)VariableAlloc(Parser->pc, Parser, sizeof(struct ExpressionStack), false);
...
{
    struct Value *ValueLoc = VariableAllocValueFromType(Parser->pc, Parser, PushType, false, nullptr, false);
...
{
    struct Value *ValueLoc = VariableAllocValueFromType(Parser->pc, Parser, &Parser->pc->IntType, false, nullptr, false);
...
{
    struct Value *ValueLoc = VariableAllocValueFromType(Parser->pc, Parser, &Parser->pc->FPType, false, nullptr, false);
...
void ExpressionPrefixOperator(struct ParseState *Parser, struct ExpressionStack **StackTop, enum LexToken Op, struct Value *TopValue)
{
    ...
    debugf((char*)"ExpressionPrefixOperator()\n");
    switch (Op)
    {
        case TokenAmpersand:
...
{
    debugf((char*)"ExpressionPostfixOperator()\n");
    if (TopValue->Typ == &Parser->pc->FPType)
    {
        /* floating point prefix arithmetic */
        double ResultFP = 0.0;
...
void ExpressionInfixOperator(struct ParseState *Parser, struct ExpressionStack **StackTop, enum LexToken Op, struct Value *BottomValue, struct Value *TopValue)
{
    ...
    debugf((char*)"ExpressionInfixOperator()\n");
...
void ExpressionStackCollapse(struct ParseState *Parser, struct ExpressionStack **StackTop, int Precedence, int *IgnorePrecedence)
{
    ...
    debugf((char*)"ExpressionStackCollapse(%d):\n", Precedence);
#ifdef DEBUG_EXPRESSIONS
    ExpressionStackShow(Parser->pc, *StackTop);
#endif
    while (TopStackNode != nullptr && TopStackNode->Next != nullptr && FoundPrecedence >= Precedence)
    {
        ...
        if (FoundPrecedence >= Precedence && TopOperatorNode != nullptr)
        {
            ...
            switch (TopOperatorNode->Order)
            {
                case OrderPrefix:
                    /* prefix evaluation */
                    debugf((char*)"prefix evaluation\n");
                    TopValue = TopStackNode->Val;

                    /* pop the value and then the prefix operator - assume they'll still be there until we're done */
                    //FIXME
                    //HeapPopStack(Parser->pc, nullptr, sizeof(struct ExpressionStack) + sizeof(struct Value) + TypeStackSizeValue(TopValue));
                    HeapPopStack(Parser->pc, sizeof(struct ExpressionStack) + sizeof(struct Value) + TypeStackSizeValue(TopValue));
                    //FIXME
                    //HeapPopStack(Parser->pc, TopOperatorNode, sizeof(struct ExpressionStack));
                    HeapPopStack(Parser->pc, sizeof(struct ExpressionStack));
                ...
                case OrderPostfix:
                    /* postfix evaluation */
                    debugf((char*)"postfix evaluation\n");
                ...
                case OrderInfix:
                    ...
                    if (TopValue != nullptr)
                    {
                        ...
                        HeapPopStack(Parser->pc, sizeof(struct ExpressionStack) + sizeof(struct Value) + TypeStackSizeValue(BottomValue));
    ...
    debugf((char*)"ExpressionStackCollapse() finished\n");
#ifdef DEBUG_EXPRESSIONS
    ExpressionStackShow(Parser->pc, *StackTop);
#endif
}
...
void ExpressionStackPushOperator(struct ParseState *Parser, struct ExpressionStack **StackTop, enum OperatorOrder Order, enum LexToken Token, int Precedence)
{
    ...
    *StackTop = StackNode;
    debugf((char*)"ExpressionStackPushOperator()\n");
#ifdef FANCY_ERROR_MESSAGES
    StackNode->Line = Parser->Line;
    StackNode->CharacterPos = Parser->CharacterPos;
#endif
...
void ExpressionGetStructElement(struct ParseState *Parser, struct ExpressionStack **StackTop, enum LexToken Token)
{
    ...
    if (Parser->Mode == RunModeRun)
    {
        ...
        struct Value *MemberValue = nullptr;
        struct Value *Result;

        /* if we're doing '->' dereference the struct pointer first */
        if (Token == TokenArrow)
            DerefDataLoc = (char*)VariableDereferencePointer(Parser, ParamVal, &StructVal, nullptr, &StructType, nullptr);
        ...
        HeapPopStack(Parser->pc, sizeof(struct ExpressionStack) + sizeof(struct Value) + TypeStackSizeValue(StructVal));
        *StackTop = (*StackTop)->Next;

        /* make the result value for this member only */
        Result = VariableAllocValueFromExistingData(Parser, MemberValue->Typ, (AnyValue *)(DerefDataLoc + MemberValue->Val->Integer), true, (StructVal != nullptr) ? StructVal->LValueFrom : nullptr);
        ExpressionStackPushValueNode(Parser, StackTop, Result);
    }
}
    ...
    do
    {
            ...
            if (PrefixState)
            {
                ...
                if (Token == TokenOpenBracket)
                {
                    ...
                    if (IsTypeToken(Parser, BracketToken, LexValue) && (StackTop == nullptr || StackTop->Op != TokenSizeof) )
                    {
                        ...
                        TypeParse(Parser, &CastType, &CastIdentifier, nullptr);
        ...
        else if (Token == TokenIdentifier)
        {
            ...
            else
            {
                ...
                {
                    struct Value *VariableValue = nullptr;
    ...
    if (StackTop != nullptr)
    {
        ...
        if (Parser->Mode == RunModeRun)
        {
            ...
            *Result = StackTop->Val;
            ...
            HeapPopStack(Parser->pc, sizeof(struct ExpressionStack) + sizeof(struct Value) + TypeStackSizeValue(StackTop->Val));
    }

    debugf((char*)"ExpressionParse() done\n\n");
#ifdef DEBUG_EXPRESSIONS
    ExpressionStackShow(Parser->pc, StackTop);
#endif
...
{
    struct Value *ReturnValue = nullptr;
    struct Value *Param;
    struct Value **ParamArray = nullptr;
    int ArgCount;
    enum LexToken Token;
    ...
    if (Parser->Mode == RunModeRun)
    {
        ...
        ParamArray = (Value**)HeapAllocStack(Parser->pc, sizeof(struct Value *) * MDef->NumParams);
    ...
    if (Parser->Mode == RunModeRun)
    {
        ...
        for (Count = 0; Count < MDef->NumParams; Count++)
            VariableDefine(Parser->pc, Parser, MDef->ParamName[Count], ParamArray[Count], nullptr, true);
...
void ExpressionParseFunctionCall(struct ParseState *Parser, struct ExpressionStack **StackTop, const char *FuncName, int RunIt)
{
    ...
    if (RunIt)
    {
        ...
        ReturnValue = (*StackTop)->Val;
        HeapPushStackFrame(Parser->pc);
        ParamArray = (Value**)HeapAllocStack(Parser->pc, sizeof(struct Value *) * FuncValue->Val->FuncDef.NumParams);
        if (ParamArray == nullptr)
            ProgramFail(Parser, "out of memory");
    }
    else
    ...
    if (RunIt)
    {
        ...
        if (FuncValue->Val->FuncDef.Intrinsic == nullptr)
        {
            ...
            for (Count = 0; Count < FuncValue->Val->FuncDef.NumParams; Count++)
                VariableDefine(Parser->pc, Parser, FuncValue->Val->FuncDef.ParamName[Count], ParamArray[Count], nullptr, true);
            ...
            ((void (*)(struct ParseState *, struct Value *, struct Value **, int))(FuncValue->Val->FuncDef.Intrinsic))(Parser, ReturnValue, ParamArray, ArgCount);
