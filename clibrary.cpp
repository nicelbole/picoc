...
static const bool __ENDIAN_CHECK__ = 1;
...
void LibraryInit(Picoc *pc)
{
	...
	VariableDefinePlatformVar(pc, nullptr, (char*)"PICOC_VERSION", pc->CharPtrType, (union AnyValue *)&pc->VersionString, false);

	//define endian-ness macros
	BigEndian = ((*(char*)&__ENDIAN_CHECK__) == 0);
	LittleEndian = ((*(char*)&__ENDIAN_CHECK__) == 1);

	VariableDefinePlatformVar(pc, nullptr, (char*)"BIG_ENDIAN", &pc->IntType, (union AnyValue *)&BigEndian, false);
	VariableDefinePlatformVar(pc, nullptr, (char*)"LITTLE_ENDIAN", &pc->IntType, (union AnyValue *)&LittleEndian, false);
}
...
void CLibraryInit(Picoc *pc)
{
    ...
    VariableDefinePlatformVar(pc, nullptr, (char*)"NULL", &pc->IntType, (union AnyValue *)&ZeroValue, false);
    VariableDefinePlatformVar(pc, nullptr, (char*)"TRUE", &pc->IntType, (union AnyValue *)&TRUEValue, false);
    VariableDefinePlatformVar(pc, nullptr, (char*)"FALSE", &pc->IntType, (union AnyValue *)&ZeroValue, false);
}
...
{
    ReturnValue->Val->Pointer = (char*)PlatformGetLine((char*)Param[0]->Val->Pointer, GETS_BUF_MAX, nullptr);
